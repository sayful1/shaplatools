...
function shapla_two_third_last( $atts, $content = null ) {
	return '<div class="shapla-column shapla-two-third shapla-column-last">' . do_shortcode( $content ) . '</div><div class="clear"></div>';
}
endif;
...
function shapla_button( $atts, $content = null ) {
	...
	if ( ! empty( $args['icon'] ) ) {
		if ( $args['icon_order'] == 'before' ) {
			$button_content = shapla_icon( array( 'icon' => $args['icon'] ) );
...
function shapla_alert( $atts, $content = null ) {
	...
	return '<div class="shapla-section shapla-alert shapla-alert--'. esc_attr( $args['style'] ) .'">' . do_shortcode( $content ) . '</div>';
}
endif;
...
function shapla_divider( $atts, $content = null ) {
	...
	return '<hr class="shapla-section shapla-divider shapla-divider--'. esc_attr( $args['style'] ) .'">';
}
endif;
