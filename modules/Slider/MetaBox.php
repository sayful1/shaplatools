...
class MetaBox {
	...
	public function __construct() {
		...
		add_action( 'manage_' . $this->slide_type . '_posts_custom_column', array( $this, 'columns_content' ) );
	}
	...
	public function add_meta_box() {
		$meta_box      = array(
			...
			'description' => sprintf(
				__( 'To use this slider in your posts or pages use the following shortcode: %s%s%s',
					'shaplatools' ),
