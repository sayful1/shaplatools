...
class MetaBox {
	...
	public function __construct() {
		...
		add_action( 'manage_' . $this->post_type . '_posts_custom_column', array( $this, 'columns_content' ) );
	}
	...
	public function add_tinymce_plugin( $plugin_array ) {
		$plugin_array['shaplatools_testimonial_mce_button'] = SHAPLATOOLS_ASSETS . '/mce-button/mce-testimonial.js';
	...
	public function client_avatar() {
		...
		add_meta_box(
			'postimagediv',
			__( 'Client\'s Avatar', 'shaplatools' ),
