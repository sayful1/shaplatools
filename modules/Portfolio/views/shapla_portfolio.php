	...
	<?php if ( $loop->have_posts() ) : ?>
        <div id="filter" class="filter shapla-row shapla-portfolio-terms">
			...
			if ( $terms && ! is_wp_error( $terms ) ) {
				echo '<ul>';
				echo sprintf( '<li><a class="active" href="#" data-group="all">%s</a></li>',
					__( 'All', 'shaplatools' ) );
        ...
        <div id="grid" class="shapla-row shapla-portfolio-items">
			<?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
				...
				?>
                <div id="ID-<?php the_ID(); ?>" class="item shapla-col <?php echo $attributes['thumbnail']; ?>"
                     data-groups='<?php echo $tax; ?>'>
