...
class Shapla_Dribbble_Widget extends WP_Widget {
	...
	function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'dribbble_name' ); ?>"><?php _e( 'Username:',
					'shaplatools' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'dribbble_shots' ); ?>"><?php _e( 'Number of shots to show:',
					'shaplatools' ); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'new_window' ); ?>"><?php _e( 'Open links in new window?',
					'shaplatools' ); ?></label>
        </p>
