 ...
 */
!function(e){"use strict";e(document).ready(function(){var t=e("#grid");t.shuffle({itemSelector:".item",speed:500}),e("#filter a").click(function(a){a.preventDefault(),e("#filter a").removeClass("active"),e(this).addClass("active");var i=e(this).attr("data-group");t.shuffle("shuffle",i)})})}(jQuery);