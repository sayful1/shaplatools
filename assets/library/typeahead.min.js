 ...
 * Custom
 */
!function(e){"use strict";if(e().typeahead){var a=new Bloodhound({datumTokenizer:Bloodhound.tokenizers.obj.whitespace("value"),queryTokenizer:Bloodhound.tokenizers.whitespace,remote:{url:shaplatools.ajaxurl+"?action=shapla_search&_wpnonce="+shaplatools.nonce+"&terms=%QUERY",wildcard:"%QUERY"}});a.initialize(),e('input[name="s"]').typeahead({hint:!0,highlight:!0,minLength:2},{name:"s",display:"value",source:a.ttAdapter()}).on("typeahead:selected",function(e,a){null!==a.url&&(window.location=a.url)})}}(jQuery);
