    ...
    var menu_items = [
        {
            text: editor.getLang('shapla.media_elements'), menu: [
                {
                    text: editor.getLang('shapla.image'), onclick: function (e) {
                        addPopup('image')
                    }
                },
                {
                    text: editor.getLang('shapla.video'), onclick: function (e) {
                        addPopup('video')
                    }
                },
            ]
        ...
        {
            onclick: function (e) {
                addPopup('widget_area')
            }, text: editor.getLang('shapla.widget_area')
        },
        {
            onclick: function (e) {
                addPopup('button')
            }, text: editor.getLang('shapla.button')
        },
        {
            onclick: function (e) {
                addPopup('columns')
            }, text: editor.getLang('shapla.columns')
        },
        {
            onclick: function (e) {
                addPopup('dropcap')
            }, text: editor.getLang('shapla.dropcap')
        },
        {
            onclick: function (e) {
                addPopup('tabs')
            }, text: editor.getLang('shapla.tabs')
        },
        {
            onclick: function (e) {
                addPopup('toggle')
            }, text: editor.getLang('shapla.toggle')
        },
        {
            onclick: function (e) {
                addPopup('icon')
            }, text: editor.getLang('shapla.icon')
        },
        {
            onclick: function (e) {
                addPopup('map')
            }, text: editor.getLang('shapla.map')
        }
    ];
