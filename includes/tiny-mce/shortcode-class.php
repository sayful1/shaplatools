				...
				switch ( $param['type'] ) {
					...
					case 'select' :
						...
						foreach ( $param['options'] as $value => $option ) {
							$output .= "<option value='$value' " . selected( $value, $param['std'],
									false ) . ">$option</option>";
						}
					...
					case 'buttonset' :
						...
						foreach ( $param['options'] as $value => $option ) {
							$output .= "<input data-key='$pkey' id='{$pkey}_{$value}' name='$pkey' type='radio' value='$value' " . checked( $value,
									$param['std'], false ) . " />";
					...
					case 'image';
						$output = $row_start;
						$output .= '<a href="#" data-type="image" data-text="Insert Image" class="shapla-open-media button" title="' . esc_attr__( 'Choose Image',
								'shaplatools' ) . '">' . __( 'Choose Image', 'shaplatools' ) . '</a>';
					...
					case 'video';
						$output = $row_start;
						$output .= '<a href="#" data-type="video" data-text="Insert Video" class="shapla-open-media button" title="' . esc_attr__( 'Choose Video',
								'shaplatools' ) . '">' . __( 'Choose Video', 'shaplatools' ) . '</a>';
						$output .= '<input class="shapla-input" type="text" name="' . $pkey . '" id="' . $pkey . '" value="' . $param['std'] . '" />';
						$output .= $row_end;
						$this->append_output( $output );
						break;
