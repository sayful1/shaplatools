...
class ShaplaTools_TinyMCE {
	/**
	 * The one instance of ShaplaTools_TinyMCE.
	 *
	 * @since 2.0.0.
	 *
	 * @var ShaplaTools_TinyMCE
	 */
	private static $instance;

	/**
	 * Instantiate or return the one ShaplaTools_TinyMCE instance.
	 *
	 * @since  2.0.0.
	 *
	...
	public function add_tinymce_plugin( $plugins ) {
		global $shaplatools;
		$plugins['shaplatools_mce_hr_button'] = $shaplatools->plugin_url() . '/assets/mce-button/mce-hr.js';
	...
	public function style_formats( $settings ) {
		$style_formats = array(
			// Big (big)
			array(
				'title'   => __( 'Run In', 'shapla' ),
				'block'   => 'p',
				'classes' => 'shapla-intro-text run-in',
			),
			array(
				'title' => __( 'Alert', 'shapla' ),
				'items' => array(
					array(
						'title'      => __( 'Green', 'shapla' ),
						'block'      => 'p',
						'attributes' => array(
 ...
 * @return ShaplaTools_TinyMCE
 */
function shapla_get_tinmyce_styles() {
	return ShaplaTools_TinyMCE::instance();
}

add_action( 'admin_init', 'shapla_get_tinmyce_styles' );
